...
| Update, roll back, remove     | yes                        | Absolute link to this plugin's GitHub Releases for version history (also works on npm), commands with an exact version (`<name>@X.Y.Z`, `#vX.Y.Z`), and what stays behind after removal. |
